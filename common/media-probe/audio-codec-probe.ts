import { aviAudioCodecs } from '@project/common/media-probe/avi';
import ByteReader from '@project/common/media-probe/byte-reader';
import { isoBmffAudioSampleFormats } from '@project/common/media-probe/iso-bmff';
import { matroskaAudioCodecIds } from '@project/common/media-probe/matroska';
...
export const probeAudioTracks = async (blob: Blob): Promise<ProbedAudioTrack[] | undefined> => {
    try {
        ...
        asbWarn('media/probe', 'Failed to probe audio codecs:', e);
        return undefined;
    }
};
