...
Most contributors should use the published, locked FFmpeg runtime above and do not need to build FFmpeg. Contributors changing FFmpeg should follow the FFmpeg runtime instructions in the repository's [FFmpeg README](https://github.com/asbplayer/asbplayer/blob/main/ffmpeg/README.md).
